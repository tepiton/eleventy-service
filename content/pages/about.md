...
stats:
  ...
  - { value: "3-8", label: "Weeks per project" }
  - { value: "2", label: "Audit slots a month" }
---
...
- **Calm beats clever.** The best design decisions are usually
  deletions. We will say no to half of your ideas, kindly, and be right
  about most of them.
- **Craft is a habit, not a phase.** The same care that goes into the
  logo goes into the empty states, the error copy, and the invoice
  template.
